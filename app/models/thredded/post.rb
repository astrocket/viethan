...
module Thredded
  class Post < ActiveRecord::Base
    ...
    belongs_to :parent_post, class_name: 'Thredded::Post', optional: true
    has_many :child_posts, -> { order "created_at ASC" }, class_name: 'Thredded::Post', foreign_key: 'parent_post_id'
